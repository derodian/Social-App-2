...
abstract class $UserPreferencesCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: FirestoreFieldName.language) String languageCode});
}
...
class _$UserPreferencesImpl
  ...
  const _$UserPreferencesImpl(
      ...
      @JsonKey(name: FirestoreFieldName.language) this.languageCode = 'en'});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserPreferences(themeMode: $themeMode, languageCode: $languageCode)';
  }
...
abstract class _UserPreferences implements UserPreferences {
  const factory _UserPreferences(
      ...
      final AppThemeMode themeMode,
      @JsonKey(name: FirestoreFieldName.language)
      final String languageCode}) = _$UserPreferencesImpl;
