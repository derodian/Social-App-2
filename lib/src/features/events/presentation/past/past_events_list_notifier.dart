...
part 'past_events_list_notifier.g.dart';

@riverpod
class PastEventsListNotifier extends _$PastEventsListNotifier {
  ...
  Stream<List<Event>> _watchEvents() {
    ...
    return eventRepository.watchPastEventsList(limit: _pageSize);
  }
  ...
  Future<void> loadMore() async {
    ...
    final newEvents = await eventRepository.fetchPastEventsList(
      limit: _pageSize,
